                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputName"
                                       name="Name" value="<?php if (isset($series_info)){echo $series_info['name'];} ?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputCreator"
                                       name="Creator" value="<?php if (isset($series_info)){echo $series_info['creator'];} ?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputSeasons"
                                       name="Seasons" value="<?php if (isset($series_info)){echo $series_info['seasons'];} ?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="inputAbstract"
                                          name="Abstract" required><?php if (isset($series_info)){echo $series_info['abstract'];} ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-10">
